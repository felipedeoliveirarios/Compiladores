...
TOKENS_DE_SINCRONIZAÇÃO = ['P', 'V', 'A', 'ES', 'CMD', 'CP', 'R', 'CP_R', 'LD', 'COND', 'CAB', 'EXP_R']
...
class Estado:
	...
	def __init__(self, regras_de_transicao, classe, final, mensagem_de_erro = ""):
...
lista_de_estados["S4"] = Estado(
								...
								None,
								False,
								"Era esperado um dígito ou sinal"
								)
